...
class SignpayOrderController extends AddonsController {
	var $model;
	function _initialize() {
		$this->model = $this->getModel ( 'signpay_order' );
		parent::_initialize ();
	}
	// 通用插件的列表模型
	public function lists() {
		...
		$res['title']='支付记录';
		$res['url']=addons_url('Signpay://SignpayOrder/lists',$param);
		$res ['class'] = _CONTROLLER == 'SignpayOrder' ? 'current' : '';
		$nav[]=$res;
		$this->assign('nav',$nav);
